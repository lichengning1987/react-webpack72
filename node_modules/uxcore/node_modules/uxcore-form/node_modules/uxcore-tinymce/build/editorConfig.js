...
var plugins = ['advlist autolink lists link image charmap print preview anchor', 'searchreplace visualblocks code fullscreen', 'insertdatetime media table contextmenu paste code', 'upload', 'placeholder', 'variable', 'noneditable'];
...
exports["default"] = {
    ...
    plugins: plugins,
    content_css: ['//g.alicdn.com/platform/c/tinymce/4.3.12/custom_content.css'],
